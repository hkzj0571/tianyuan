    ...
    <div class="container-wrap">
        <aside id="fh5co-hero">
            <div class="flexslider">
                <ul class="slides">
                    <li style="background-image: url(frontends/images/img_bg_3.jpg);">
        ...
        <div id="fh5co-about">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center animate-box">
                    <p><img src="frontends/images/cover_bg_3.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive"></p>
                </div>
